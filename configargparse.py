    ...
    def _parse_known_args_impl(
        ...
        if ignore_help_args:
            args = [
                arg
                for idx, arg in enumerate(args)
                if arg not in self.get_possible_help_args() or idx > double_minus_pos
            ]
        ...
        actions_with_env_var_values = [
            ...
            and not self.already_on_command_line(args, a.option_strings)
        ]
        ...
        for config_items in all_config_items:
            ...
            for key, value in config_items.items():
                if key in known_config_keys:
                    ...
                    discard_this_key = self.already_on_command_line(
                    ...
                    discard_this_key = (
                        ...
                        or self.already_on_command_line(
                            args,
                            [
        ...
        for action in self._actions:
            ...
            if (
                self.already_on_command_line(args, action.option_strings)
        ...
        if intermixed:
            namespace, unknown_args = super().parse_known_intermixed_args(
            ...
            if source == _COMMAND_LINE_SOURCE_KEY:
                ...
                for action in self._actions:
                    ...
                    if (
                        ...
                        and self.already_on_command_line(
