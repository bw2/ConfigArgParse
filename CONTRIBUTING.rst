...
- Once that PR is approved and merged, the *owner* should push a new tag with the same name as the version i.e. ``1.5.1`` by running `git tag 1.5.1; git push --tags`. 
