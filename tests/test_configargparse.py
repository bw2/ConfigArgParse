...
# Tests for the newly added parsers in 1.5.5
from configargparse import parse_toml_section_name, unquote_str, IniConfigParser, TomlConfigParser, CompositeConfigParser
...
class TestNewlyAddedParsersInVersion_1_5_5(TestCase):
    ...
    def test_CompositeConfigParser(self):
        p = CompositeConfigParser([TomlConfigParser(['soft']), 
                                IniConfigParser(['soft'], True)])
